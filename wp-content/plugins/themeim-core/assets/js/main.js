;(function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        // Brand Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-brand-carousel-one-widget.default', function ($scope) {
            activeBrandSlider($scope);
        });
        // Brand Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-gallery-carousel-one-widget.default', function ($scope) {
            activeGallerySlider($scope);
        });
        // Case Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-performance-single-item-widget.default', function ($scope) {
            activePerformanceSliderOne($scope);
        });
        // Case Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-course-slider-one-widget.default', function ($scope) {
            activePerformanceSliderOne($scope);
        });
        // Header Slider Three
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-header-slider-three-widget.default', function ($scope) {
            activeHeaderSliderOne($scope);
        });
        // Service Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-service-slider-one-widget.default', function ($scope) {
            activeServiceGridSliderOne($scope);
        });
        // Service Slider Four
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-service-slider-four-widget.default', function ($scope) {
            activeServiceGridSliderOne($scope);
        });
        // Testimonial Slider one
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-testimonial-one-widget.default', function ($scope) {
            activeTestimonialSliderOne($scope);
        });
        // Testimonial Slider two
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-testimonial-two-widget.default', function ($scope) {
            activeTestimonialSliderOne($scope);
        });
        // Testimonial Slider three
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-testimonial-three-widget.default', function ($scope) {
            activeTestimonialSliderOne($scope);
        });
        // Packages Slider one
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-packages-single-slider-widget.default', function ($scope) {
            activeTestimonialSliderOne($scope);
        });
        // Packages Slider two
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-packages-single-slider-two-widget.default', function ($scope) {
            activeTestimonialSliderOne($scope);
        });
        // Packages Slider one
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-deals-single-slider-widget.default', function ($scope) {
            activeTestimonialSliderOne($scope);
        });
        // Team Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-team-member-one-widget.default', function ($scope) {
            activeTeamMemberSliderOne($scope);
        });
        // Blog Slider
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-blog-one-widget.default', function ($scope) {
            activeBlogGridSliderOne($scope);
        });
        // Blog Slider Two
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-blog-two-widget.default', function ($scope) {
            activeBlogGridSliderOne($scope);
        });
        // Blog Slider Three
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-blog-three-widget.default', function ($scope) {
            activeBlogGridSliderOne($scope);
        });
        /* Counter Up */
        elementorFrontend.hooks.addAction('frontend/element_ready/themeim-counterup-one-widget.default', function ($scope) {
