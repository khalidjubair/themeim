...
if (!class_exists('Themeim_Core_Admin_Menu')) {

    class Themeim_Core_Admin_Menu
    {
       /**
        * $instance
        * @since 1.0.0
        ...
        */
        ...
        public function theme_admin_menu_page()
        {
            ...
            //add menu page
            add_menu_page(
                esc_html__('Themeim Page', 'themeim-core'),
                esc_html__('Themeim', 'themeim-core'),
                'manage_options',
                'themeim_theme_options',
                array($this, 'admin_options_fallback_function'),
                THEMEIM_CORE_ADMIN_ASSETS . '/img/icon.png',
                80
            );
        }
            ...
            $tab_menus = array(
                'service' => array(
                    array(
                        ...
                        'name' => sprintf(esc_html__('%s', 'themeim-core'), 'Service'),
                        'id' => 'edit-service'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=service-cat&post_type=service',
                        'name' => sprintf(esc_html__('%s Categories', 'themeim-core'), 'Service'),
                        'id' => 'edit-service-cat'
                    )
                ),
                'packages' => array(
                    array(
                        ...
                        'name' => sprintf(esc_html__('%s', 'themeim-core'), 'Packages'),
                        'id' => 'edit-packages'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=packages-cat&post_type=packages',
                        'name' => sprintf(esc_html__('%s Categories', 'themeim-core'), 'Packages'),
                ...
                'deals' => array(
                    array(
                        ...
                        'name' => sprintf(esc_html__('%s', 'themeim-core'), 'Deals'),
                        'id' => 'edit-deals'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=deals-cat&post_type=deals',
                        'name' => sprintf(esc_html__('%s Categories', 'themeim-core'), 'Deals'),
                        'id' => 'edit-deals-cat'
                    )
                ),
                'team' => array(
                    array(
                        ...
                        'name' => sprintf(esc_html__('%s', 'themeim-core'), 'Team'),
                        'id' => 'edit-team'
                    ),
                    array(
                        'link' => 'edit-tags.php?taxonomy=team-cat&post_type=team',
                        'name' => sprintf(esc_html__('%s Categories', 'themeim-core'), 'Team'),
                        'id' => 'edit-team-cat'
                    )
                )
            );
        ...
        public function admin_menu_activation()
        {
            ...
            <script type="text/javascript">
                (function ($) {
                    ...
                    mainwrap = $('#toplevel_page_themeim_theme_options');
                    ...
                    if (check) {
                        $('.wp-submenu.wp-submenu-wrap')
                            .find('a[href*="admin.php?page=toplevel_page_themeim_theme_options"]')
                            .removeClass('current')
                            .parent('li')
                            .removeClass('current');
                    }
    ...
    if (class_exists('Themeim_Core_Admin_Menu')) {
        Themeim_Core_Admin_Menu::getInstance();
    }
