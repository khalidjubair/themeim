...
class Themeim_Category_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'themeim_category',
            esc_html__( 'Themeim:  Category', 'themeim-core' ),
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $all_terms ) ):?>
            ...
            esc_html__( ' Oops, there are no category.', 'themeim-core' )
            ?>
        <?php endif; ?>
        </ul>
        <?php
    ...
    public function form( $instance ) {
        ...
        if (!empty($instance) && $instance['title']) {
            ...
            $title = esc_html__('Category', 'themeim-core');
        ...
        $taxonomy = array(
            'category' => esc_html__('Blog Category', 'themeim-core'),
            'packages-cat' => esc_html__('Packages Category', 'themeim-core'),
            'deals-cat' => esc_html__('Deals Category', 'themeim-core'),
            'course-category' => esc_html__('Courses Category', 'themeim-core'),
            'service-cat' => esc_html__('Service Category', 'themeim-core')
        );
        $order_arr   = array(
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')) ?>"><?php esc_html_e('Number', 'themeim-core'); ?></label>
...
if ( ! function_exists( 'Themeim_Category_Widget' ) ) {
    function Themeim_Category_Widget() {
        register_widget( 'Themeim_Category_Widget' );
    }

    add_action( 'widgets_init', 'Themeim_Category_Widget' );
}