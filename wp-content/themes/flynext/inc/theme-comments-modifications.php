...
if ( ! function_exists( 'flynext_comment_modification' ) ) {
	function flynext_comment_modification($comment, $args, $depth) {
		...
		<div class="single-comment-wrap"><!-- single comment wrap -->
			...
			<div class="content">
                ...
                <span class="date"> <?php printf('<span class="date">%s</span>',get_comment_date('d M Y'));?></span>
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<em class="comment-awaiting-moderation"><?php echo esc_html__( 'Your comment is awaiting moderation.', 'flynext' ); ?></em>
				<?php endif; ?>
				<?php comment_text(); ?>
				<?php
				comment_reply_link( array_merge( $args, array(
					'reply_text' => esc_html__('Reply','flynext') ,
					'before' => '',
					'class'  => '',
					'depth' => $depth,
