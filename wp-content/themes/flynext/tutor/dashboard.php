...
?>
    ...
    <div class="tutor-wrap tutor-dashboard tutor-dashboard-student padding-top-120 padding-bottom-100">
                    ...
                    <div class="tutor-dashboard-header">
                        ...
                        <div class="tutor-dashboard-header-info">
                            <div class="tutor-dashboard-header-display-name">
                                <h4><?php esc_html__('Howdy,', 'flynext'); ?> <strong><?php echo esc_html($user->display_name); ?></strong> </h4>
                            </div>
                            ...
                            if (current_user_can(tutor()->instructor_role)){
                                ...
                                <div class="tutor-dashboard-header-stats">
                                    <div class="tutor-dashboard-header-ratings">
                                        ...
                                        <span> (<?php echo sprintf(__('%d Ratings', 'flynext'), $instructor_rating->rating_count); ?>) </span>
                                    </div>
                        ...
                        <div class="tutor-dashboard-header-button">
                            ...
                            if (tutils()->get_option('enable_become_instructor_btn')) {
                                ?>
                                    <a style="vertical-align:middle" class="tutor-btn bordered-btn" href="<?php echo esc_url(tutils()->instructor_register_url()); ?>">
                                        <?php echo sprintf(__("%s Become an instructor", 'flynext'), '<i class="tutor-icon-man-user"></i> &nbsp;'); ?>
                                    </a>
                                <?php
                            }
                            ...
                            if(current_user_can(tutor()->instructor_role)){
                                ...
                                <a class="tutor-btn bordered-btn" href="<?php echo apply_filters('frontend_course_create_url', admin_url("post-new.php?post_type=".tutor()->course_post_type)); ?>">
                                    <?php echo sprintf(__('%s Add A New Course ', 'flynext'), '<i class="tutor-icon-checkbox-pen-outline"></i> &nbsp;'); ?>
                                </a>
                                <?php
                            }
                                ...
                                esc_html__('Your Application is pending from', 'flynext'), ' <b>', $on, '</b>',
                                    '</span>';
                            }
                            else if($rejected_on || $instructor_status!=='blocked'){
                                echo esc_url($become_button);
                            }
                            ?>
                        </div>
                                ...
                                <div class="tutor-instructor-rejection-notice">
                                    <?php 
                                        ...
                                        echo '<span>
                                            ...
                                            esc_html__('Your application to become an instructor was rejected on', 'flynext') . ' ' . $on .
                                        '</span>
