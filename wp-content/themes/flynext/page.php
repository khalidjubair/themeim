...
$page_layout_meta = flynext_Group_Fields_Value::page_layout('flynext');
$page_container_meta = flynext_Group_Fields_Value::page_container('flynext','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area flynext-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
