...
$page_layout_meta = themeim_Group_Fields_Value::page_layout('themeim');
$page_container_meta = themeim_Group_Fields_Value::page_container('themeim','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area themeim-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
